%//////////////////////////////////////////////////////////////////////////
%below functions demonstrate the basis images of haar transform.
...
LL3=proto_matrix;
LL3(4,4)=1;
LL3_rev=harr_2d_L_reverse(LL3,3);
...
HL3=proto_matrix;
HL3(4,12)=1;
HL3_rev=harr_2d_L_reverse(HL3,3);
...
HL2=proto_matrix;
HL2(8,24)=1;
HL2_rev=harr_2d_L_reverse(HL2,3);
...
HL1=proto_matrix;
HL1(16,48)=1;
HL1_rev=harr_2d_L_reverse(HL1,3);
...
LH3=proto_matrix;
LH3(12,4)=1;
LH3_rev=harr_2d_L_reverse(LH3,3);
...
HH3=proto_matrix;
HH3(12,12)=1;
HH3_rev=harr_2d_L_reverse(HH3,3);
...
LH2=proto_matrix;
LH2(16,48)=1;
LH2_rev=harr_2d_L_reverse(LH2,3);
...
HH2=proto_matrix;
HH2(24,24)=1;
HH2_rev=harr_2d_L_reverse(HH2,3);
...
LH1=proto_matrix;
LH1(48,16)=1;
LH1_rev=harr_2d_L_reverse(LH1,3);
...
HH1=proto_matrix;
HH1(48,48)=1;
HH1_rev=harr_2d_L_reverse(HH1,3);
